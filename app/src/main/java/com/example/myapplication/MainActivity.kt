    ...
    class MainActivity : ComponentActivity() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            setContent {
                MessageCard(Message("Jetpack Compose tutorial", "Jetpack Compose is a" +
    ...
    data class Message(val author: String, val body: String, val letter: String)
    ...
    fun MessageCard(msg: Message) {
        Row() {
            ...
            Image(
                painter = painterResource(R.drawable.android_compose),
        ...
        Column() {
            ...
            Text(text = msg.author, fontSize = 24.sp, modifier = Modifier.padding(all = 16.dp))
            Text(text = msg.body, textAlign = TextAlign.Justify, modifier = Modifier.padding(16.dp,0.dp,16.dp,0.dp))
            Text(text = msg.letter, textAlign = TextAlign.Justify, modifier = Modifier.padding(all = 16.dp))
    ...
    fun PreviewMessageCard() {
        MessageCard (
            msg = Message("Android", "haha", "Washing Washing")
        )
    }
